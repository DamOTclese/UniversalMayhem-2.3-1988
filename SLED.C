...
void perform_sled(void)
{
   ...
   for (sleds = 0, sled_count = 0, sitting_on = (short)NIL; sleds < 5; sleds++) {
...
*/
   ...
   if (sitting_on == (short)NIL) {
	 ...
	 c_out(YELLOW, "You already have 5 attack sled swarms deployed\n\r");
	 return;
      }
